...
class BenchbaseRunner:
    def __init__(self, dbms, test, target_path="./workload_running_results/temp_results", config_path="./src/optimizer/configs/postgres/tpcc_config.xml"):
