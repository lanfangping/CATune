...
class DBMSTemplate(ABC):
    ...
    def __init__(self, db, user, password, port, host, restart_cmd, recover_script, knob_info_path=None):
    ...
    def from_file(cls, config_path):
        ...
        return cls(db, db_user, password, port, host, restart_cmd, recover_script)
